## cargoship dataset versions

List the versions of one dataset, newest first

```
cargoship dataset versions S3_URL --dataset-id ID [flags]
```

### Options

```
      --dataset-id string   Dataset ID to list versions of (from 'cargoship dataset list')
