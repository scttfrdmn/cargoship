...
|---------|------|-------|-------|-------|--------|--------|--------|
| v0.24.1 | 2026-09-10 | — | — | direct, chunked | — | ⏳ Run in progress | (attached to the release by the real-AWS lane) |
| v0.24.0 | 2026-09-10 | — | — | direct, chunked | — | ⏳ Run in progress | (attached to the release by the real-AWS lane) |
